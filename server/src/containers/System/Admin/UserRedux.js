  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.PositionRedux !== this.props.PositionRedux) {
      ...
      this.setState({
        ...
        position:
          positionArrs && positionArrs.length > 0 ? positionArrs[0].keyMap : "",
      });
    }
  ...
  render() {
    ...
    return (
      <div className="user-redux-container">
        <div className="title">Using Redux</div>
        <div className="user-redux-body">
          <div className="container">
            <div className="row">
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.email" />
                </label>
                <input
                  value={email}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.password" />
                </label>
                <input
                  value={password}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.first-name" />
                </label>
                <input
                  value={firstName}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.last-name" />
                </label>
                <input
                  value={lastName}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.phone-number" />
                </label>
                <input
                  value={phonenumber}
              ...
              <div className="col-9">
                <label>
                  <FormattedMessage id="manage-users.address" />
                </label>
                <input
                  value={address}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.gender" />
                </label>
                <select
                  className="form-control"
                  value={gender}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.position" />
                </label>
                <select
                  className="form-control"
                  value={position}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.role" />
                </label>
                <select
                  className="form-control"
                  value={role}
              ...
              <div className="col-3">
                <label>
                  <FormattedMessage id="manage-users.image" />
                </label>
